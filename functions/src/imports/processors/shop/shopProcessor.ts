...
function itemDetailWrites(row: ImportRow, importId: string): BulkSetInput[] {
...
function lotNumberWrites(row: ImportRow, importId: string): BulkSetInput[] {
  const itemId = read(row, ["ItemID"]);
...
function serialAvailabilityWrites(row: ImportRow, importId: string): BulkSetInput[] {
