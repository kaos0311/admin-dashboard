export const glass = {
  ...
  shell:
    "relative z-10 mx-auto w-full max-w-7xl min-w-0 px-4 py-6 sm:px-6 lg:px-8",

  shellTight:
    "relative z-10 mx-auto w-full max-w-6xl min-w-0 px-4 py-6 sm:px-6 lg:px-8",

  shellFull:
    "relative z-10 w-full min-w-0 px-4 py-6 sm:px-6 lg:px-8",

  panel:
    "relative min-w-0 overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/48 shadow-[0_20px_80px_rgba(0,0,0,0.42),0_0_45px_rgba(34,211,238,0.075)] backdrop-blur-2xl",
