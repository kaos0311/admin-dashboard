...
export function buildSearchText(item: InventoryItemWithoutMeta): string {
  return normalizeSearchText(
    [
      ...
      item.lastReturnedAt,
      item.returnedFromPatientKey,
      item.returnedFromPatientName,
      item.returnReason,
      item.parNumber,
      item.orderingDoctor,
      item.primaryDoctor,
...
export function normalizeInventoryItem(
  ...
  const itemWithoutSearch: InventoryItemWithoutMeta = {
    ...
    lastDeliveredAt: toSafeString(data.lastDeliveredAt),
    lastReturnedAt: toSafeString(data.lastReturnedAt),
    returnedFromPatientKey: toSafeString(data.returnedFromPatientKey),
    returnedFromPatientName: toSafeString(data.returnedFromPatientName),
    activeAssetArchived: data.activeAssetArchived === true,
    patientEquipmentArchived: data.patientEquipmentArchived === true,
    returnReason: toSafeString(data.returnReason),
    pendingScanReview: data.pendingScanReview === true,
    scanSource: toSafeString(data.scanSource),
