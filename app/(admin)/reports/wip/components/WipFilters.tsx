      ...
      <div className="grid gap-3 lg:grid-cols-[1fr_220px_220px]">
        <label className="relative">
          ...
          <input
            ...
            className="h-11 w-full rounded-2xl border border-white/10 bg-black/20 pl-11 pr-4 text-sm text-white outline-none placeholder:text-slate-600 focus:border-amber-300/40"
          />
        </label>
        ...
        <select
          ...
          className="h-11 rounded-2xl border border-white/10 bg-black/20 px-4 text-sm text-white outline-none focus:border-amber-300/40"
        >
