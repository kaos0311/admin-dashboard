...
export default function SettingsPage() {
  const [activeTab, setActiveTab] =
    useState<SettingsTabKey>("company");
            ...
            <div className="relative flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p
                    className={`mt-3 max-w-3xl ${typography.body}`}
                  >
                    Manage company defaults,
                    Command Center behavior, user
                    access, role controls, security
                    settings, maintenance mode, and
                    reset tools. This is the room
                    where one bad click can make the
                    whole building smell like burnt
                    wiring.
                  </p>
                </div>
              </div>
          ...
          {loading ? (
            <section className={glass.panel}>
              ...
              <div className="relative flex min-h-64 items-center justify-center p-6">
                <div
                  className={`flex items-center gap-3 text-sm ${typography.bodyMuted}`}
                >
