export const tables = {
  ...
  table:
    "min-w-full divide-y divide-[#2a2a2a] text-sm",
  caption:
    "sr-only",
  head:
    "bg-[#222222] text-xs uppercase tracking-[0.16em] text-[#888888]",
  headRow:
  ...
  row:
    "transition hover:bg-[#222222]",
  selectedRow:
    "bg-[#7a9a5e]/10 transition hover:bg-[#7a9a5e]/15",
  cell:
